...
import { Loader2, Lock, Clock, UserPlus } from 'lucide-react';
...
export function NewWorkOrderModal({ clients, onClose, onSubmit }: NewWorkOrderModalProps) {
  ...
  // Estado para controlar abertura do modal de cadastro rápido
            ...
            <div>
              ...
              <div className="flex gap-2">
                <select
                  ...
                  className="flex-1 rounded-lg border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-800 px-3.5 py-2.5 text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                ...
                <button
                  ...
                  className="rounded-lg bg-blue-600 hover:bg-blue-700 text-white px-3 py-2.5 flex items-center justify-center transition-colors"
                >
                  <UserPlus size={18} />
                </button>
              </div>
